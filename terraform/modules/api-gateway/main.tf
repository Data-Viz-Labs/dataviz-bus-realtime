...
# Usage Plan without rate limiting or quota
resource "aws_api_gateway_usage_plan" "hackathon" {
  name        = "hackathon-usage-plan"
  description = "Usage plan for hackathon participants (no rate limiting or quota)"
  ...
  # No throttle settings = unlimited requests
  # No quota settings = unlimited quota
